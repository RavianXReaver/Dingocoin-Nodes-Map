...
prod-docker: ## Production - Self-hosted (full stack + Caddy SSL)
	...
	@docker compose $(COMPOSE_PROD_DOCKER) --profile with-caddy up -d --force-recreate
	@echo ""
	@echo "$(GREEN)╔═══════════════════════════════════════╗$(RESET)"
...
prod-docker-no-caddy: ## Production - Self-hosted WITHOUT container Caddy (use host proxy)
	...
	@docker compose $(COMPOSE_PROD_DOCKER) up -d --force-recreate
	@echo ""
	@echo "$(GREEN)╔═══════════════════════════════════════╗$(RESET)"
	@echo "$(GREEN)║       PRODUCTION READY                ║$(RESET)"
	@echo "$(GREEN)╚═══════════════════════════════════════╝$(RESET)"
...
prod-cloud: ## Production - Cloud DB + Docker app + Caddy SSL
	...
	@docker compose $(COMPOSE_PROD_CLOUD) --profile with-caddy up -d --force-recreate
	@echo ""
	@echo "$(GREEN)╔═══════════════════════════════════════╗$(RESET)"
	@echo "$(GREEN)║       PRODUCTION READY                ║$(RESET)"
	@echo "$(GREEN)╚═══════════════════════════════════════╝$(RESET)"
